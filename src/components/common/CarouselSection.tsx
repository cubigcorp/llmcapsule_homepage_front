...
const defaultSlides: SlideData[] = [
  {
    image: getAssetPath('/images/background_01.png'),
    content: getAssetPath('/images/Content_1.svg'),
    title: '실시간 프롬프트 필터링',
    description:
      '프롬프트 입력 시 이름, 연락처, 계좌번호 등 민감정보를 즉시 감지하고 자동 가명화하여 유출을 방지합니다. 사용자가 인식하지 못하는 사이에 모든 개인정보가 안전하게 보호됩니다.',
  },
  {
    image: getAssetPath('/images/background_03.png'),
    content: getAssetPath('/images/Content_2.svg'),
    title: '문서 내 민감정보 탐지',
    description:
      '업로드/첨부되는 각종 문서에서도 민감정보를 실시간으로 탐지하여 자동 가명화 또는 마스킹 처리합니다. AI가 대량의 문서 속 숨겨진 개인정보까지 놓치지 않고 안전하게 관리합니다.',
  },
  {
    image: getAssetPath('/images/background_02.png'),
    content: getAssetPath('/images/Content_3.svg'),
    title: '문맥 기반 정보 탐지',
    description:
  ...
  {
    image: getAssetPath('/images/background_03.png'),
    content: getAssetPath('/images/Content_4.svg'),
